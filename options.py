...
parser.add_argument(
    '--data_dir',
    type=str,
    default='D:\Data-Efficient-Model-Compression-master\CIP/data/cifar100/',
    help='The directory where the input data is stored.')
parser.add_argument(
    '--job_dir',
    type=str,
    default='experiments/vgg16_mmd_0.002',
    help='The directory where the summaries will be stored. vgg16, resnet56, googlenet')
parser.add_argument(
    '--prune_dir',
    type=str,
    default='experiments/vgg16_mmd_0.002/checkpoint/model.pth',
    help='The directory where the summaries will be stored. vgg16, resnet56, googlenet')
parser.add_argument(
    '--teacher_dir',
    type=str,
    default='./pretrained/vgg16_mmd1.pth.tar',
...
parser.add_argument(
    ...
    type=str,
    default='vgg16',
    help='The model of student. atgapvgg16')
parser.add_argument(
    '--teacher_model',
    type=str,
    default='vgg16',
